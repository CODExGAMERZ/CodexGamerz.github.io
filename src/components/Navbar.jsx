...
export default function Navbar() {
  ...
  return (
    <nav className={`navbar ${isScrolled ? 'scrolled' : ''}`} id="navbar">
      <a href="#" className="nav-logo-wrapper" onClick={() => setIsOpen(false)}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="nav-logo-icon">
          <path d="M16 18l6-6-6-6M8 6L2 12l6 6" />
          <path d="M13 2l-2.5 8h3.5l-3.5 12 4.5-10h-3.5z" fill="currentColor" stroke="none" />
        </svg>
        <span className="nav-logo">Aryan.</span>
      </a>
